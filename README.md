...
Напишите функцию, которая принимает два натуральных числа ___x___ и ___n___ и возвращает ___x___ в степени ___n___. Иначе говоря, умножает ___x___ на себя ___n___ раз и возвращает результат.
